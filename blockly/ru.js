...
if (window.location.href.indexOf("lang=ru")>=0) {
  ...
  /** @export */ Blockly.Msg.ESPRUINO_WAIT = 'wait (ждать)';
  /** @export */ Blockly.Msg.ESPRUINO_SECONDS = 'seconds (секунд)';
  /** @export */ Blockly.Msg.ESPRUINO_WAIT_TOOLTIP = 'Подождать указанное число секунд';
  /** @export */ Blockly.Msg.ESPRUINO_AFTER = 'after (через)';
  /** @export */ Blockly.Msg.ESPRUINO_AFTER_TOOLTIP = 'Запустить код через указанное число секунд';

  /** @export */ Blockly.Msg.ESPRUINO_EVERY = 'every (каждые)';
  /** @export */ Blockly.Msg.ESPRUINO_EVERY_TOOLTIP = 'Повторять запуск кода с указанным интервалом';

  /** @export */ Blockly.Msg.ESPRUINO_MORE = 'Ещё';
  /** @export */ Blockly.Msg.ESPRUINO_BACK = 'Назад';
  /** @export */ Blockly.Msg.ESPRUINO_PIN_NAME = 'Название Пина';

  /** @export */ Blockly.Msg.ESPRUINO_WATCH = 'watch (отследить)';
  /** @export */ Blockly.Msg.ESPRUINO_WATCH_TOOLTIP = 'Запустить код при изменении на входе';
  /** @export */ Blockly.Msg.ESPRUINO_TIME = 'Time (время)';
  /** @export */ Blockly.Msg.ESPRUINO_TIME_TOOLTIP = 'Читает текущее время в секундах';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE = 'digitalWrite Pin (записать число в Пин)';
  /** @export */ Blockly.Msg.ESPRUINO_VALUE = 'Value (значение)';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE_TOOLTIP = 'Записывает дискретное значение в Пин';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE = 'digitalPulse Pin (пульсировать)';
  /** @export */ Blockly.Msg.ESPRUINO_MILLISECONDS = 'Milliseconds (Миллисекунд)';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE_TOOLTIP = 'Отправляет импульсы в Пин с указанным интервалом в миллисекундах';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD = 'digitalRead Pin (прочитать число из Пина)';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD_TOOLTIP = 'Прочитать дискретное значение из Пина';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE = 'analogWrite Pin (записать аналог)';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE_TOOLTIP = 'Записать аналоговое значение в Пин';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD = 'analogRead Pin (прочитать аналог) ';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD_TOOLTIP = 'Прочитать аналоговое значение из Пина';
  /** @export */ Blockly.Msg.ESPRUINO_PINMODE = 'pinMode Pin';
  /** @export */ Blockly.Msg.ESPRUINO_PINMODE_TOOLTIP = 'Sets the mode of the pin (if not used, pin mode is set automatically)';
  /** @export */ Blockly.Msg.ESPRUINO_JS_TOOLTIP = 'Запустить кусочек JavaScript';
  /** @export */ Blockly.Msg.ESPRUINO_JSEXPR_TOOLTIP = 'Запустить кусочек JavaScript';
  /** @export */ Blockly.Msg.ESPRUINO_MOVE_SERVO = 'Move Servo on Pin (Переместить серво на пине)';
  /** @export */ Blockly.Msg.ESPRUINO_TO = 'to (в)';
  /** @export */ Blockly.Msg.ESPRUINO_MOVE_SERVO_TOOLTIP = 'Запустить серво привод на пине в позицию между -1 и 1';
  /** @export */ Blockly.Msg.ESPRUINO_STOP_SERVO = 'Stop Servo on Pin (остановить серво)';
  /** @export */ Blockly.Msg.ESPRUINO_STOP_SERVO_TOOLTIP = 'Остановить серво привод';
  /** @export */ Blockly.Msg.ESPRUINO_ULTRASONIC_GET_TRIG = 'Get distance (измерить расстояние), trigger (излучатель) ';
