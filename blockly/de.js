...
if (window.location.href.indexOf("lang=de")>=0) {
  ...
  /** @export */ Blockly.Msg["COLOUR_PICKER_TOOLTIP"] = "Wählt eine Farbe aus der Palette aus.";
  ...
  /** @export */ Blockly.Msg["LISTS_GET_INDEX_FIRST"] = "Erste";
  ...
  /** @export */ Blockly.Msg["LISTS_GET_INDEX_RANDOM"] = "Zufällig";
  ...
  /** @export */ Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] = "Ist entweder wahr oder falsch";
  ...
  /** @export */ Blockly.Msg["LOGIC_TERNARY_IF_FALSE"] = "falls falsch";
  ...
  /** @export */ Blockly.Msg["MATH_ATAN2_HELPURL"] = "https://de.wikipedia.org/wiki/Arctan2";
  /** @export */ Blockly.Msg["MATH_ATAN2_TITLE"] = "atan2 von X:%1 Y:%2";
  /** @export */ Blockly.Msg["MATH_ATAN2_TOOLTIP"] = "Gibt den Arkustangens des Punktes (X, Y) in Grad von -180 bis 180 zurück.";
  ...
  /** @export */ Blockly.Msg["MATH_CONSTANT_TOOLTIP"] = "Mathematische Konstanten wie: p (3.141…), e (2.718…), f (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…) oder 8 (unendlich).";
  ...
  /** @export */ Blockly.Msg["MATH_IS_TOOLTIP"] = "Überprüft ob eine Zahl gerade, ungerade, eine Primzahl, ganzzahlig, positiv, negativ oder durch eine zweite Zahl teilbar ist.  Gibt wahr oder falsch zurück.";
  ...
  /** @export */ Blockly.Msg["MATH_TRIG_TOOLTIP_SIN"] = "Ist der Sinus des Winkels (nicht Radiant).";
  /** @export */ Blockly.Msg["MATH_TRIG_TOOLTIP_TAN"] = "Ist der Tangens des Winkels (nicht Radiant).";
  ...
  /** @export */ Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"] = "nach";
  ...
  /** @export */ Blockly.Msg["TEXT_ISEMPTY_TOOLTIP"] = "Ist wahr, falls der Text keine Zeichen enthält.";
  ...
  /** @export */ Blockly.Msg.ESPRUINO_WAIT = 'warten';
  /** @export */ Blockly.Msg.ESPRUINO_SECONDS = 'Sekunden';
  /** @export */ Blockly.Msg.ESPRUINO_WAIT_TOOLTIP = 'Verzögere für eine bestimme Zeit';
  /** @export */ Blockly.Msg.ESPRUINO_AFTER = 'nach';
  /** @export */ Blockly.Msg.ESPRUINO_AFTER_TOOLTIP = 'Warte für eine bestimmte Zeit bevor der Code läuft';

  /** @export */ Blockly.Msg.ESPRUINO_EVERY_TOOLTIP = 'Lässt Code wiederholt laufen, für eine bestimmte Zeit';
  /** @export */ Blockly.Msg.ESPRUINO_EVERY = 'jede';

  /** @export */ Blockly.Msg.ESPRUINO_MORE = 'Mehr';
  /** @export */ Blockly.Msg.ESPRUINO_BACK = 'Weniger';
  /** @export */ Blockly.Msg.ESPRUINO_PIN_NAME = 'Der Name des Pins';

  /** @export */ Blockly.Msg.ESPRUINO_WATCH = 'beobachte';
  /** @export */ Blockly.Msg.ESPRUINO_WATCH_TOOLTIP = 'Lässt Code bei Änderungen am Eingang laufen';
  /** @export */ Blockly.Msg.ESPRUINO_TIME = 'Zeit';
  /** @export */ Blockly.Msg.ESPRUINO_TIME_TOOLTIP = 'Lies die aktuelle Zeit in Sekunden';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE = 'digitalWrite Pin';
  /** @export */ Blockly.Msg.ESPRUINO_VALUE = 'Wert';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE_TOOLTIP = 'Schreibe einen digitalen Wert an Pin';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE = 'digitalPulse Pin';
  /** @export */ Blockly.Msg.ESPRUINO_MILLISECONDS = 'Millisekunden';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE_TOOLTIP = 'Pulse einen Pin für eine angegebene Anzahl an Millisekunden';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD = 'digitalRead Pin';
  /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD_TOOLTIP = 'Lese einen digitalen Wert von Pin';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE = 'analogWrite Pin';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE_TOOLTIP = 'Schreibe einen digitalen Wert an Pin';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD = 'analogRead Pin';
  /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD_TOOLTIP = 'Lese einen analogen Wert von Pin';
  /** @export */ Blockly.Msg.ESPRUINO_PINMODE = 'pinMode Pin';
  /** @export */ Blockly.Msg.ESPRUINO_PINMODE_TOOLTIP = 'Setze den Modus des Pins (wenn nicht benutzt wird der Modus automatisch gesetzt)';
  /** @export */ Blockly.Msg.ESPRUINO_JS_TOOLTIP = 'Führt den angegebenen JavaScript Code aus';
  /** @export */ Blockly.Msg.ESPRUINO_JSEXPR_TOOLTIP = 'Führt den angegebenen JavaScript Code als Ausdruck aus';
  /** @export */ Blockly.Msg.ESPRUINO_MOVE_SERVO = 'Bewegt den Servo an Pin';
  /** @export */ Blockly.Msg.ESPRUINO_TO = 'zu';
