...
if (window.location.href.indexOf("lang=en")>=0 ||
    window.location.href.indexOf("lang=")==-1) {
      ...
      /** @export */ Blockly.Msg.ESPRUINO_WAIT = 'wait';
      /** @export */ Blockly.Msg.ESPRUINO_SECONDS = 'seconds';
      /** @export */ Blockly.Msg.ESPRUINO_WAIT_TOOLTIP = 'Delay for a certain amount of time';
      /** @export */ Blockly.Msg.ESPRUINO_AFTER = 'after';
      /** @export */ Blockly.Msg.ESPRUINO_AFTER_TOOLTIP = 'Waits for a certain period before running code';

      /** @export */ Blockly.Msg.ESPRUINO_EVERY_TOOLTIP = 'Runs code repeatedly, every so many seconds';
      /** @export */ Blockly.Msg.ESPRUINO_EVERY = 'every';

      /** @export */ Blockly.Msg.ESPRUINO_MORE = 'More';
      /** @export */ Blockly.Msg.ESPRUINO_BACK = 'Back';
      /** @export */ Blockly.Msg.ESPRUINO_PIN_NAME = 'The Name of a Pin';

      /** @export */ Blockly.Msg.ESPRUINO_WATCH = 'watch';
      /** @export */ Blockly.Msg.ESPRUINO_WATCH_TOOLTIP = 'Runs code when an input changes';
      /** @export */ Blockly.Msg.ESPRUINO_TIME = 'Time';
      /** @export */ Blockly.Msg.ESPRUINO_TIME_TOOLTIP = 'Read the current time in seconds';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE = 'digitalWrite Pin';
      /** @export */ Blockly.Msg.ESPRUINO_VALUE = 'Value';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALWRITE_TOOLTIP = 'Writes a Digital Value to a Pin';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE = 'digitalPulse Pin';
      /** @export */ Blockly.Msg.ESPRUINO_MILLISECONDS = 'Milliseconds';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALPULSE_TOOLTIP = 'Pulses a pin for the given number of milliseconds';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD = 'digitalRead Pin';
      /** @export */ Blockly.Msg.ESPRUINO_DIGITALREAD_TOOLTIP = 'Read a Digital Value from a Pin';
      /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE = 'analogWrite Pin';
      /** @export */ Blockly.Msg.ESPRUINO_ANALOGWRITE_TOOLTIP = 'Writes an Analog Value to a Pin';
      /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD = 'analogRead Pin';
      /** @export */ Blockly.Msg.ESPRUINO_ANALOGREAD_TOOLTIP = 'Read an Analog Value from a Pin';
      ...
      /** @export */ Blockly.Msg.ESPRUINO_JS_TOOLTIP = 'Executes the given JavaScript code';
      /** @export */ Blockly.Msg.ESPRUINO_JSEXPR_TOOLTIP = 'Executes the given JavaScript code as an expression';
      /** @export */ Blockly.Msg.ESPRUINO_MOVE_SERVO = 'Move Servo on Pin';
      /** @export */ Blockly.Msg.ESPRUINO_TO = 'to';
      /** @export */ Blockly.Msg.ESPRUINO_MOVE_SERVO_TOOLTIP = 'Start moving the servo motor - position between -1 and 1';
      /** @export */ Blockly.Msg.ESPRUINO_STOP_SERVO = 'Stop Servo on Pin';
      /** @export */ Blockly.Msg.ESPRUINO_STOP_SERVO_TOOLTIP = 'Stop moving the servo motor';
      /** @export */ Blockly.Msg.ESPRUINO_ULTRASONIC_GET_TRIG = 'Get distance, trigger';
