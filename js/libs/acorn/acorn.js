...
(function(root, mod) {
  ...
  function makePredicate(words) {
    return {
      "abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile": function(str) {
        switch (str.length) {
        case 6:
          switch (str) {
          case "double":
      ...
      "class enum extends super const export import": function(str) {
        switch (str.length) {
        case 5:
          switch (str) {
          case "class":
      ...
      "implements interface let package private protected public static yield": function(str) {
        switch (str.length) {
        case 9:
          switch (str) {
          case "interface":
      ...
      "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this": function(str) {
        switch (str.length) {
        case 4:
          switch (str) {
          case "case":
      ...
      "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this let const class extends export import yield": function(str) {
        switch (str.length) {
        case 5:
          switch (str) {
          case "break":
